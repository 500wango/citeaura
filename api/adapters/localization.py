...
EXACT_DESCS_EN = {
    ...
    "按 audit.json 里分数最低的 10 页逐页改：H1 唯一、H2 拆到 6–10 节、列表密度 ≥0.35、加更新日期": "Improve the lowest-scoring pages with a unique H1, clear topic-driven sections, useful lists where appropriate, and an accurate update date.",
    ...
    "海外 AI 引用的可识别语言里英文占 82.90%–95.07%，机翻页进不了候选池（global-platforms.md）": "Native, useful English pages improve retrieval coverage for global audiences; validate results against the configured platforms and sampling period.",
