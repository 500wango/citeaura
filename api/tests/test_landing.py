...
def test_landing_page_is_public_and_links_to_application():
    ...
    assert '<title data-i18n="landing.title">AI Visibility Tracking &amp; GEO Software | CiteAura</title>' in response.text
    assert 'id="hero-title" data-i18n="landing.hero_title"' in response.text
    assert "Track your AI visibility.<br>Know what to fix." in response.text
