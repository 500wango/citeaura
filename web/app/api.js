...
export const projects = {
  ...
  advanceVisibilityPhase: (id, current_phase, completed_phases = []) => request(`/api/v1/projects/${encodeURIComponent(id)}/visibility-plan`, { method: 'PUT', body: { current_phase, completed_phases } }),
  captureVisibilityBaseline: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/visibility-plan/baseline`, { method: 'POST' }),
  getCitationReadiness: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/citation-readiness`),
  createReadinessTickets: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/citation-readiness/tickets`, { method: 'POST' }),
  getBrandOpportunities: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/brand-opportunities`),
  createOpportunityTickets: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/brand-opportunities/tickets`, { method: 'POST' }),
  createOpportunityTicket: (id, opportunityId) => request(`/api/v1/projects/${encodeURIComponent(id)}/brand-opportunities/${encodeURIComponent(opportunityId)}/ticket`, { method: 'POST' }),
  getCitationSources: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/citation-sources`),
  getCitationFeatures: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/citation-features`),
  createCitationTicket: (id, body) => request(`/api/v1/projects/${encodeURIComponent(id)}/citation-sources/tickets`, { method: 'POST', body }),
  getEntities: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/entities`),
  saveEntities: (id, items) => request(`/api/v1/projects/${encodeURIComponent(id)}/entities`, { method: 'PUT', body: { items } }),
  restoreEntity: (id, entityId) => request(`/api/v1/projects/${encodeURIComponent(id)}/entities/${encodeURIComponent(entityId)}/restore`, { method: 'POST' }),
  getOffsiteAttribution: (id) => request(`/api/v1/projects/${encodeURIComponent(id)}/offsite-attribution`),
